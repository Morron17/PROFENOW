...
<?php if(session('temporaryPassword')): ?>
<script>
document.addEventListener("DOMContentLoaded", function() {
    if (Notification.permission === "granted") {
        new Notification("Recuperación de contraseña", {
            body: "Tu nueva contraseña es: <?php echo e(session('temporaryPassword')); ?>"
        });
    }
});
</script>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('password.email')); ?>" method="POST">
                ...
                <div class="text-center mt-3">
                    <a href="<?php echo e(route('auth.register')); ?>">¿No tenés cuenta? Registrate aquí</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\tomas\OneDrive\Escritorio\laragon-portable\www\profenow\resources\views/auth/login.blade.php ENDPATH**/ ?>